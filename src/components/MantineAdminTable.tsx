...
const MantineAdminTable = ({menuId}: MantineAdminTableProps) => {
        const columns = useMemo<MRT_ColumnDef<MenuItem>[]>(
            () => [
                ...
                {
                    header: 'Category', // replace 'title' with 'Header' or the correct property name
                    accessorKey: 'categoryName', // replace 'field' with 'accessor' or the correct property name
                },
                {
                    header: 'Actions',
                    accessorKey: 'id',
...
export default MantineAdminTable;